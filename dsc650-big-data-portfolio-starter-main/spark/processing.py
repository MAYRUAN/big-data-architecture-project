"""
Spark processing script from final project 'sparkml.py'
...
# Step 2: Load the data from the Hive table 'branch_growth' into a Spark DataFrame (Input the script read)
growth_df = spark.sql("SELECT Ad_Budget_K, New_Accnts_Opened FROM branch_growth")

# Step 3: Handle null values by either dropping or filling them (Perform Transformations)
...
# Step 8: Print the model performance metrics (Create Output)
